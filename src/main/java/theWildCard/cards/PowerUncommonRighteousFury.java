...
public class PowerUncommonRighteousFury extends AbstractDefaultCard {

    public static final String ID = DefaultMod.makeID(PowerUncommonRighteousFury.class.getSimpleName());
    ...
    public PowerUncommonRighteousFury() {
