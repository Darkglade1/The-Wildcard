...
public class CleansingBlow extends AbstractDefaultCard {
    ...
    public static final String ID = DefaultMod.makeID(CleansingBlow.class.getSimpleName());
    public static final String IMG = makeCardPath("Attack.png");// "public static final String IMG = makeCardPath("CleansingBlow.png");
