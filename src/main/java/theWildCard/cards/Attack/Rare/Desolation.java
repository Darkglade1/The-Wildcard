...
public class Desolation extends AbstractDefaultCard {

    public static final String ID = WildcardMod.makeID(Desolation.class.getSimpleName());
    public static final String IMG = makeCardPath("Desolation.png");
