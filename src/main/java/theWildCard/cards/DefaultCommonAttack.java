...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = WildcardMod.makeID(DefaultCommonAttack.class.getSimpleName());
    ...
    // The list of all of them can be found in the main WildcardMod.java file in the
    ...
    // Go check out DefaultAttackWithVariable and theWildCard.variable.DefaultCustomVariable
