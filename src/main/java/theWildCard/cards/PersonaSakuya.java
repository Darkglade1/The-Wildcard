...
public class PersonaSakuya extends AbstractPersonaCard {

    public static final String ID = DefaultMod.makeID(PersonaSakuya.class.getSimpleName());
