...
public class PersonaMichael extends AbstractPersonaCard {

    public static final String ID = DefaultMod.makeID(PersonaMichael.class.getSimpleName());
