...
public class Unburden extends AbstractDefaultCard {
    ...
    public static final String ID = DefaultMod.makeID(Unburden.class.getSimpleName());
    public static final String IMG = makeCardPath("Attack.png");// "public static final String IMG = makeCardPath("Unburden.png");
