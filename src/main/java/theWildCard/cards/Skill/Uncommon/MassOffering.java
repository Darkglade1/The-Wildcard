...
public class MassOffering extends AbstractDefaultCard {
    ...
    public static final String ID = DefaultMod.makeID(MassOffering.class.getSimpleName());
    public static final String IMG = makeCardPath("Attack.png");// "public static final String IMG = makeCardPath("MassOffering.png");
