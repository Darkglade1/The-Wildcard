...
public class SkillUncommonSincereOffering extends AbstractDefaultCard {

    public static final String ID = DefaultMod.makeID(SkillUncommonSincereOffering.class.getSimpleName());
    public static final String IMG = makeCardPath("Attack.png");// "public static final String IMG = makeCardPath("SkillUncommonSincereOffering.png");
    ...
    public SkillUncommonSincereOffering() {
