...
public class PowerUncommonVileAura extends AbstractDefaultCard {

    public static final String ID = DefaultMod.makeID(PowerUncommonVileAura.class.getSimpleName());
