...
public class PersonaSatanaelPower extends AbstractPower {
    ...
    public static final String POWER_ID = DefaultMod.makeID("PersonaSatanaelPower");
    ...
    public PersonaSatanaelPower(final AbstractCreature owner, final AbstractCreature source, int amount) {
        name = NAME;
        ID = POWER_ID;
